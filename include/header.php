<?php
  ...
  if ($_REQUEST['op']=='login' ||
      (isset($_REQUEST['state']) && isset($_REQUEST['code']))) $rdio->authenticate();
...
<html>
  <head>
    ...
    <meta name="apple-itunes-app" content="app-id=451237105" />
    <script src="https://ajax.googleapis.com/ajax/libs/swfobject/2.2/swfobject.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js"></script>
    <script type="text/javascript">
      var loggedIn = <?php print $rdio->is_authenticated()?'true':'false'; ?>;
      ...
      var previews = <?php print $c->previews?'true':'false'; ?>;
<?php if ($c->debug): ?>
